        ...
        <div className="max-w-4xl mx-auto px-4 py-2.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              className="bg-orange-100 hover:bg-orange-200 text-orange-700 p-2 sm:px-3 sm:py-1.5 rounded-xl font-bold text-xs flex items-center gap-1.5 transition-colors min-h-[40px] sm:min-h-[auto]"
              title="Sortear Times"
            >
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-2.5 sm:px-3 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1.5 shadow-md shadow-emerald-200 transition-all active:scale-95 min-h-[40px]"
            ...
            <button
              ...
              className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-2.5 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1 transition-colors min-h-[40px]"
